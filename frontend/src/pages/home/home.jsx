...
const Home = () => {
  ...
  useEffect(() => {
    ...
    if (firstMatch) {
      ...
      if (category === "furniture") navigate("/furniture");
      else if (category === "stationery") navigate("/stationery");
    }
      ...
      <div className="home-container">
          ...
          <div className="hero-content">
            <div className="hero-text">
              ...
              <p className="hero-subtitle">
                Turn your clutter into next semester's coffee budget.
              </p>
            </div>
        ...
        <section className="categories-section">
          ...
          <div className="categories-grid">
            <Link to="/stationery" className="category-card">
              <div className="category-icon stationary-icon"><span>✏️</span></div>
            ...
            <Link to="/furniture" className="category-card">
              <div className="category-icon furniture-icon"><span>🪑</span></div>
              <div className="category-info">
                <h3>Furniture</h3>
        ...
        <div className="info-section-bottom">
          ...
          <div className="info-cards">
            <div className="info-card"><div className="info-card-icon">🎓</div><h4>Student-Verified</h4><p>Exclusive community of verified university students only</p></div>
            <div className="info-card"><div className="info-card-icon">💰</div><h4>Zero Fees</h4><p>No hidden charges. Keep 100% of your earnings</p></div>
            <div className="info-card"><div className="info-card-icon">🤝</div><h4>Safe Meetups</h4><p>Meet sellers on campus in secure, public locations</p></div>
            ...
            <div className="footer-content">
              <div className="footer-grid">
                <div className="footer-section">
                  ...
                  <p>Your trusted campus marketplace for student essentials. Buy and sell items safely within your university community.</p>
                </div>
                <div className="footer-section">
                  <h3>Quick Links</h3>
